...
class CannyEdgeDetector:
    def __init__(self, imgs, sigma:float =1, kernel_size:int =5, 
    ...
    def gaussian_kernel(self, size: int , sigma: float =1.0):
        size = int(size) // 2
    ...
    def sobel_filters(self, img):
        ...
        Ix = ndimage.filters.convolve(img, self.Kx)
        Iy = ndimage.filters.convolve(img, self.Ky)
    ...
    def detect(self):
        ...
        for i, img in enumerate(self.imgs):
            self.img_smoothed = convolve(img, self.gauss_kernel)
